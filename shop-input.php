...
echo("
	<center>
	<form method=post action='testboard-process.php?code=$code&buydate=$buydate' enctype='multipart/form-data'>
	...
	<td>&nbsp;<input type=text name=topic size=60 class='login'></td>
	</tr>
	<tr><td height=5></td></tr>
	<tr>
	<td align=right nowrap><font><b>첨부화일&nbsp;</b></font></td>
    <td class='r'><input type=file name='userfile' size=45 maxlength=80></td>");
	if ($UserID != admin){
	echo ("
	...
	<td style='background:white;'><textarea name=content rows=12 cols=60 id='summernote' font='arial'></textarea></td>
	</tr>");
	if ($UserID != admin){
		echo("
	<tr>
  ...
  <label for='1-star' class='star'>&#9733;</label>
	...
	<input type=submit value=등록하기 class='a'>
