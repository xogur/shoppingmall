...
<form action=register.php method=post name=comma>
	<table border=0 width=1200 height=500 style='margin-top:120px;'>

		<tr><td align=left height=50 style='border-bottom:2px solid gray;' colspan=2 valign=bottom>■회원정보입력</td></tr>
		<tr><td align=center width=200 height=50>이름</td>
			<td><input type=text size=10 name=uname></td></tr>
		<tr><td width=200 height=50 align=center>아이디(필수)</td>
			<td><input type=text size=10 name=uid><font size=2>[<a   href='javascript:id_check()'>ID중복검사</a>]</font></td></tr>
		<tr><td align=center width=200 height=50>비밀번호(필수)</td>
			<td><input type=text size=10 name=upass1></td></tr>
		<tr><td align=center width=200 height=50>비밀번호 확인(필수)</td>
			<td><input type=password   maxlength=15 style='height:20;' size=20 name=upass2></td></tr>
		<tr><td align=center width=200 height=200>주소</td>
			<td><input type=text size=7   name=zip readonly=readonly><font size=2>[<a   href='javascript:go_zip()'>우편번호검색</a>]</font><br><input type=text size=50 name=addr1 readonly=readonly><br><input   type=text size=35 name=addr2></td></tr>
		<tr><td align=center width=200 height=50>E-mail</td>
			<td><input type=text size=30 name=email></td></tr>
		<tr><td align=center width=200 height=50>전화번호</td>
			<td><input type=text size=20 name=mphone></td></tr>
		</table>
		
		
		<table border=0 width=1200 height=800 style='margin-top:100px;'>
		<tr><td>■회원가입 약관동의</td></tr>
		<tr><td><div style='overflow:scroll; width:1000px; height:300px; margin-left:100px;'>배추도사 무도사 이용약관
		<br>제1장 총칙<br>
		<br>제1조 (목적)<br>
...
</div><div><input type='checkbox' name='agree' value='동의' style='margin-left:400px;'></input><font style='margin-left:1025px; position:relative; bottom:34px;'>동의</font></div></td></tr>
<tr><td>■개인정보 수집,이용동의</td></tr>
<tr>
...
<div><input type='checkbox' name=agree value='동의' style='margin-left:400px;'></input><font style='margin-left:1025px; position:relative; bottom:34px;'>동의</font></div></form></center></td></td></tr>
</form>
</table>
